...
export const Contact = () => {
    ...
    const item = {
        ...
        show: { opacity: 1, y: 0, transition: { duration: 0.4, ease: 'easeIn', viewport: { once: true, amount: 1 }, } },
    }
    return (
        <motion.div className='contact'>
            ...
            <motion.form
                ...
                <motion.p variants={item} className='text-left text-xl mb-2 md:mb-4 md:text-5xl lg:text-8xl'>HELLO,</motion.p>

                <motion.label variants={item} htmlFor="name" className='text-xl md:text-5xl lg:text-7xl'>MY NAME IS</motion.label>
                <motion.input
                    variants={item}
                    type="text"
                    name='name' required
                ...
                <br />
                <motion.label variants={item} htmlFor="email" className='text-xl md:text-5xl lg:text-7xl'>HERE IS MY EMAIL</motion.label>
                <motion.input variants={item} type="email" id='email' name='email' autoComplete='off'
                ...
                <br />
                <motion.label variants={item} htmlFor="topic" className='text-xl md:text-5xl lg:text-7xl'>LET'S TALK ABOUT</motion.label>
                <motion.input variants={item} type="text" name='topic' autoComplete='off'
            ...
            <motion.div
                ...
                <div className='hover:text-pink-200 hover:line-through md:text-2xl lg:text-4xl'>STALK ME</div>
                <div className='flex flex-col items-start space-y-1 md:space-y-2'>
                    <motion.a
                        whileHover={{ scale: 1.1 }}
                        whileTap={{ scale: 0.9 }}
                        transition={{ duration: 0.7, ease: 'easeInOut' }}
                        href="http://" target="_blank" className='hover:text-pink-200 hover:line-through md:text-2xl lg:text-4xl'>
